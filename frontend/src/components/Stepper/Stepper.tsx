...
const steps = [
  { 
    id: 1, 
    label: "Настройки", 
    href: (id: string) => `/invitations/edit/${id}/settings` 
  },
  { 
    id: 2, 
    label: "Събития", 
    href: (id: string) => `/invitations/edit/${id}/events` 
  },
  { 
    id: 3, 
    label: "Присъствие", 
    href: (id: string) => `/invitations/edit/${id}/rsvp` 
  },
];
...
export default function Stepper() {
  ...
  const isPreview = pathname == `/invitations/edit/${id}/preview`;
