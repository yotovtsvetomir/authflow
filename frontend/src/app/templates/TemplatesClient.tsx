  ...
  return (
    <div className="container fullHeight centerWrapper">
      ...
      <div className={styles.search}>
        <Input id="search" name="search" label="търси шаблони" value={inputSearchValue} onChange={e => setInputSearchValue(e.target.value)} />
      </div>
      ...
      <div className={styles.filters}>
        ...
        <ReactSelect options={subcategoryOptions} value={subcategory ? subcategoryOptions.find(o => o.value === subcategory) : { value: '', label: category ? 'Изберете subcategory' : 'Първо изберете категория' }} onChange={handleSubcategoryChange} isDisabled={!category} />
        <ReactSelect options={variantOptions} value={variant ? variantOptions.find(o => o.value === variant) : { value: '', label: subcategory ? 'Изберете variant' : 'Първо изберете подкатегория' }} onChange={handleVariantChange} isDisabled={!subcategory} />
      </div>
